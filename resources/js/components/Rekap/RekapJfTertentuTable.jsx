...
// RekapJfTertentuExport::$displayOrder (excel), yaitu golongan PNS
// diselang-seling dengan golongan PPPK. Key-key ini sama persis dengan
// key yang dipakai RekapService::rekapJfTertentu() di $row.pria / $row.wanita.
const DISPLAY_ORDER = [
...
// RekapJfTertentuExport::$pnsAggList.
const PNS_AGG_LIST = ["I", "II", "III", "IV"];

// Blok agregat PPPK: V, VII, IX, X, XI, Total. Harus sama dengan
// RekapJfTertentuExport::$pppkAggList.
const PPPK_LIST = ["V", "VII", "IX", "X", "XI"];

const JSON_PATH = "/rekap/jf-tertentu";
const EXPORT_PATH = "/rekap/jf-tertentu/export";
const FILENAME_PREFIX = "rekap-jf-tertentu";

function RekapJfTertentuTable() {
    ...
    // sama dengan baris TOTAL di RekapJfTertentuExport (sum per kolom).
            ...
            <div className="flex flex-wrap items-end justify-between gap-4 mb-5">
                <div>
                    <h3 className="text-lg font-bold">
                        Rekapitulasi JF Tertentu
                    </h3>
                    <p className="text-sm text-gray-500">
                        Jumlah ASN Fungsional Tertentu diperinci menurut
                        instansi, golongan ruang, dan jenis kelamin.
                    </p>
                </div>
...
export default RekapJfTertentuTable;