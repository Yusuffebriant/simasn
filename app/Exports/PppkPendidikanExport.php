...
/**
 * Export tabel "PPPK Berdasarkan Tingkat Pendidikan dan Jenis Kelamin".
 * Sumber data sama persis dengan panel React PppkPendidikanPanel.jsx,
 * yaitu StatistikService::statistikPppkPendidikan().
 *
 * Bentuk sheet identik dengan PnsPendidikanExport, cuma beda scope
 * (PPPK aktif) dan key total keseluruhan ('jumlah_pppk').
 */
class PppkPendidikanExport implements FromArray, WithEvents
{
    ...
    {
        $this->data = (new StatistikService())->statistikPppkPendidikan($periode);
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->setCellValue('D' . $totalRow, $this->data['jumlah_pppk'] ?? 0);
