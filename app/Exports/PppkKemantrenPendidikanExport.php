...
/**
 * Export tabel "PPPK Kemantren Berdasarkan Tingkat Pendidikan dan Jenis
 ...
 *
 * Sumber data: StatistikService::statistikPppkKemantrenPendidikan().
 ...
 */
class PppkKemantrenPendidikanExport implements FromArray, WithEvents
{
    ...
    public function __construct(protected ?string $periode = null)
    {
        $this->data = (new StatistikService())
            ->statistikPppkKemantrenPendidikan($periode);
